...
**関連文書**: `51.01_TechSpec_Backend.md`, `51.01_TechSpec_Frontend.md`, `52.05_ADR_Islands_Architecture_Performance.md`
...
- `51.01_TechSpec_Backend.md` - バックエンド技術仕様
- `51.01_TechSpec_Frontend.md` - フロントエンド技術仕様
- `52.05_ADR_Islands_Architecture_Performance.md` - アイランドアーキテクチャADR
- `52.02_Database_Schema.md` - データベーススキーマ
