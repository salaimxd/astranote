---
title: "ADR 005: アイランドアーキテクチャによるパフォーマンス最適化"
type: technical
status: accepted
role: TechLead
tags: [adr, performance, astro, islands]
---
...
**ステータス**: 採用済み
**決定者**: 開発チーム
**関連文書**: [51.01_TechSpec_Frontend.md](51.01_TechSpec_Frontend.md), [51.01_TechSpec_Architecture.md](51.01_TechSpec_Architecture.md)
...
| 2026-01-26 | Claude | Phase 1完了、測定結果記録              |
