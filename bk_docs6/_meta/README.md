...
| カテゴリ                                                                  | 説明                             | 主な利用職種       |
| ------------------------------------------------------------------------- | -------------------------------- | ------------------ |
| **[\_meta](#00_meta-このカテゴリ)**                                       | 運用ルール、用語集、テンプレート | 全員               |
| **[10_Strategy_Planning](../10_Strategy_Planning/README.md)**             | ビジョン、ロードマップ、OKRs     | PdM, EM, PMM       |
| **[20_Discovery_Research](../20_Discovery_Research/README.md)**           | ユーザー調査、市場分析           | PdM, Designer, PMM |
| **[30_Definition_Requirements](../30_Definition_Requirements/README.md)** | PRD、リリースノート              | PdM, EM, Designer  |
| **[40_Design_UX](../40_Design_UX/README.md)**                             | デザイン仕様、ガイドライン       | Designer, Engineer |
| **[50_Engineering_Tech](../50_Engineering_Tech/README.md)**               | 技術仕様、API、ADR               | Engineer, TechLead |
| **[60_Marketing_GTM](../60_Marketing_GTM/README.md)**                     | マーケティング、GTM戦略          | PMM, Sales         |
| **[70_Customer_Enablement](../70_Customer_Enablement/README.md)**         | 営業資料、ヘルプ、FAQ            | Sales, CS          |
...
例:
- 31.01_PRD_<Function_Name>.md
- 52.01_ADR_<Decision_Name>.md
```
...
- Gitでバージョン管理
- コミットメッセージは明確に（例: "[ドキュメント種別]-[番号]: [変更内容]"）
...
1. 各カテゴリのREADME.mdを確認
2. [00.00_README.md](00.00_README.md) の検索ガイドを参照
3. Gitで検索（ファイル名、内容）
...
- [10_Strategy_Planning](../10_Strategy_Planning/README.md)
- [20_Discovery_Research](../20_Discovery_Research/README.md)
- [30_Definition_Requirements](../30_Definition_Requirements/README.md)
- [40_Design_UX](../40_Design_UX/README.md)
- [50_Engineering_Tech](../50_Engineering_Tech/README.md)
- [60_Marketing_GTM](../60_Marketing_GTM/README.md)
- [70_Customer_Enablement](../70_Customer_Enablement/README.md)
